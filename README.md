...
```bash
cd "/Users/Halima/Documents/New project"
python3 -m venv .venv
...
```bash
cd "/Users/Halima/Documents/New project/task1-student-performance"
python3 student_performance_analysis.py --csv "StudentPerformanceFactors.csv"
```
